    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(default='profile.png', upload_to='pictures')),
                ('department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='inventory.department')),
        ...
        migrations.AddField(
            model_name='employee',
            name='userprofile',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='inventory.userprofile'),
        ),
    ]
